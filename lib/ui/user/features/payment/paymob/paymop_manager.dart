import 'package:charity/ui/user/features/payment/paymob/paymob_key.dart';
...
class PaymobManager {
  ...
  Future<String> _getPaymentKey({
    ...
    final Response response = await Dio()
      ...
      "integration_id":
          PayMopKey.integrateId, //Integration Id Of The Payment Method
