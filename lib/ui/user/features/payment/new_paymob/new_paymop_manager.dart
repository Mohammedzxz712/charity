import 'package:charity/ui/user/features/payment/new_paymob/new_paymob_key.dart';
import 'package:dio/dio.dart';

class NewPaymobManager {
  Future<String> newGetPaymentKey(int amount, String currency) async {
    try {
  ...
  Future<String> _getPaymentKey({
    ...
    final Response response = await Dio()
      ...
      "integration_id":
          NewPayMopKey.integrateId, //Integration Id Of The Payment Method
